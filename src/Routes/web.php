...
|
*/
Route::get('test', 'mawdoo3\drsk\Controllers\SearchController@testRoute')->name('asasdasad');
Route::prefix('search')->namespace('mawdoo3\drsk\Controllers')->group(function () {
